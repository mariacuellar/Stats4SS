...
# NOW Now doing it without the intermediate step

# Exploratory Data Analysis

2021 | 9 | 12 Last compiled: `r Sys.Date()`

Alright, so how do we proceed with exploratory data analysis?

First, we figure out 
1. What variables do we have?
2. What are their types?
3. Work with one variable at a time. 
